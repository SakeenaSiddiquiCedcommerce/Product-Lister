...
class Woocommmerce_Etsy_Integration {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'wp_ajax_ced_etsy_adding_delete_functionality_on_timeline', $plugin_admin, 'ced_etsy_adding_delete_functionality_on_timeline' );
		$this->loader->add_filter( 'wp_ajax_ced_etsy_add_searching_on_timeline', $plugin_admin, 'ced_etsy_add_searching_on_timeline' );
